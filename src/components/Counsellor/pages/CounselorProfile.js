        ...
        <Container className="mt-4">
              ...
              <Card.Body>
                ...
                <Row className="mt-4">
                  <Col>
                    ...
                    {counsellorById.availableTimes && counsellorById.availableTimes.map((time, index) => (
                      <Card key={index} className="mb-3 border-0 shadow-sm">
                        <Card.Body>
                          <p><strong>From:</strong> {time.from}</p>
                          <p><strong>To:</strong> {time.to}</p>
                        </Card.Body>
                      </Card>
                    ))}
                  </Col>
          ...
          <Form onSubmit={meetingSubmit} className="mt-4">
            <Form.Group controlId="proposedTime">
              <Form.Label style={{ color: '#6b21a8' }}>Propose a Meeting Time</Form.Label>
              <Form.Control
                type="datetime-local"
            ...
            <Button type="submit" style={{ backgroundColor: '#6b21a8', border: 'none' }} className="mt-3 shadow">
              Submit
            </Button>
          </Form>
        </Container>
