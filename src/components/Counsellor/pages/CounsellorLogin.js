  ...
  return (
    <Layout>
      <div style={{ height: "100vh", display: "flex", alignItems: "center", justifyContent: "center" }}>
        <Container className="d-flex flex-column flex-md-row bg-white shadow" style={{ maxWidth: "800px", height: "80vh", borderRadius: "10px", overflow: "hidden", padding: 0 }}>
          {/* Left Section */}
            ...
            <Form onSubmit={handleSubmit} style={{ width: "100%" }}>
              ...
              <div className="text-center mt-3">
                <p>
                  ...
                  <Link to="/counsellor/signup" className="text-decoration-none" style={{ color: "#6b21a8" }}>
                    Click Here
                  </Link>
                </p>
              </div>
