...
const CounsellorSideBar = () => {
  ...
  const items = [
    { text: 'Home', icon: <FaHome />, link: '/counsellor' },
    { text: 'Complete Your Profile', icon: <CgProfile />, link: '/counsellor/CounsellorCompleteProfile' },
    { text: 'Schedule Meeting', icon: <AiOutlineSchedule />, link: '/counsellor/scheduledMeeting' },
    { text: 'Requested Meeting', icon: <BsPersonBoundingBox />, link: '/counsellor/allMeetingRequests' },
  ];
