...
const AdminLogin = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await custom_axios.post("/api/v1/admin/login", {
        email,
        password,
      });
      ...
      >
        ...
        >
            ...
            <Form onSubmit={handleSubmit} style={{ width: "100%" }}>
              ...
              <div className="text-center mt-3">
                <p>
                  ...
                  <Link to="/admin/register" className="text-decoration-none" style={{ color: "#6b21a8" }}>
                    Click Here
                  </Link>
                </p>
              </div>
          ...
          >
            ...
            >
              Learnmate is the ultimate platform designed for students by students.
              Whether you're looking to buy or sell notes, or seek career guidance,
              Learnmate has got you covered!
            </p>
            <img
              src={signupImage}
              alt="Sign up"
