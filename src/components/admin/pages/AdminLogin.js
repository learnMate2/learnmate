          ...
          <Col xs={12} md={6} lg={4}>
            <div className="" style={{ borderRadius: '8px', width: "400px" }}>
              <div style={{ paddingBottom: '50px' }}>
                ...
                <p className="text-center" style={{ color: "#999999",size:"15px", }}>Login as a Admin</p>
              ...
              <Form onSubmit={handleSubmit} >
                ...
                <div>
                <p>Create new account. <Link to="/admin/register" className='already_account' >Click Here</Link></p>
                </div>
              </Form>
            </div>
          </Col>
