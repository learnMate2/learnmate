            ...
            <Col xs={12} md={6} lg={4}>
              <div className="" style={{ borderRadius: '8px', width: "400px" }}>
                <div style={{ paddingBottom: '20px' }}>
                  ...
                  <p className="text-center" style={{ color: "#999999", size: "15px", }}>Register as a Admin</p>
                </div>
                <Form onSubmit={handleSubmit}>
                  ...
                  <div>
                    <p>Already have an account? <Link to="/admin/login" className='already_account'>Click Here</Link></p>
                  </div>
                </Form>
              </div>
            </Col>
