...
const SideBar = () => {
  ...
  const items = [
    ...
    { text: 'Schedule Meeting', icon: <AiOutlineSchedule />, link: '/dashboard/schedulemeeting' },
    { text: 'Requested Meeting', icon: <BsPersonBoundingBox />, link: '/dashboard/requestedmeeting' },
    { text: 'Your Uploads', icon: <FaFolder />, link: '/dashboard/youruploadcontent' },
